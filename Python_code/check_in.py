...
heading_label = tk.Label(root, text="---------  CUSTOMER DETAILS  ---------", font=('Orbitron', 15), bg="black",
                      fg="white")
...
# vacancy Button
v_button = Button(top_frame, text="CHECK ROOMS", font=('ARIAL BLACK', 15), bg='#80002a',
                  fg='White', width=15, command=click_vacancy)
v_button.grid(row=6, column=1, ipadx=7, sticky=E)
